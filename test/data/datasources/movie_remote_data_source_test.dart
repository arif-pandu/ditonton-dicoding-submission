...
void main() {
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200', () async {
      // arrange
      when(mockIOClient.get(Uri.parse('$BASE_URL/movie/now_playing?$API_KEY'))).thenAnswer(
        (_) async => Response(
  ...
  group('get movie recommendations', () {
    ...
    test('should return list of Movie Model when the response code is 200', () async {
      // arrange
      when(mockIOClient.get(Uri.parse('$BASE_URL/movie/$tId/recommendations?$API_KEY')))
  ...
  group('search movies', () {
    ...
    test('should return list of movies when response code is 200', () async {
      // arrange
      when(mockIOClient.get(Uri.parse('$BASE_URL/search/movie?$API_KEY&query=$tQuery')))
